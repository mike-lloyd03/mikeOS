...
start:
    ...
    mov word [0xb8000], 0x0F20 ; _
    mov word [0xb8002], 0x0F20 ; _
    mov word [0xb8004], 0x0F20 ; _
    mov word [0xb8006], 0x0F20 ; _
    mov word [0xb8008], 0x0F20 ; _
    mov word [0xb800a], 0x0F20 ; _
    mov word [0xb800c], 0x0F20 ; _
    mov word [0xb800e], 0x0F20 ; _
    mov word [0xb8010], 0x0F20 ; _
    mov word [0xb8012], 0x0F20 ; _
    mov word [0xb8014], 0x0F20 ; _
    mov word [0xb8016], 0x0F20 ; _
    mov word [0xb8018], 0x0F20 ; _
    mov word [0xb801a], 0x0F20 ; _
    mov word [0xb801c], 0x0F20 ; _
    mov word [0xb801e], 0x0F20 ; _
    mov word [0xb8020], 0x0F20 ; _
    mov word [0xb8022], 0x0F20 ; _
